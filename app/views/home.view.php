        ...
        <table class="table-auto min-w-full divide-y divide-gray-300 mt-6">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="p-4 text-left text-sm font-semibold text-gray-900">Client Code</th>
                    <th class="p-4 text-left text-sm font-semibold text-gray-900">No. of linked contacts</th>
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
                <?php if (empty($clients)) { ?>
                    ...
                    foreach ($clients as $client) { ?>
                        <tr>
                            <!-- Name -->
                            <td class="p-4 text-sm text-gray-600"><?php echo htmlspecialchars($client['Name'], ENT_QUOTES, 'UTF-8'); ?></td>
                            <!-- Client Code -->
                            <td class="p-4 text-sm text-gray-600"><?php echo htmlspecialchars($client['ClientCode'], ENT_QUOTES, 'UTF-8'); ?></td>
                            <!-- No. of linked contacts -->
                            <td class="p-4 text-sm text-gray-600"><?php echo htmlspecialchars($client['Linked Contacts'], ENT_QUOTES, 'UTF-8'); ?></td>
                            <!-- Actions -->
